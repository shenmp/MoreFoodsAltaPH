! function(e, t) {
    ...
    return function(e) {
        ...
        var f = r(2),
            ...
            b = n(y),
            m = void 0;
        if (m = "mobx-react", !l.default) throw new Error(m + " requires the MobX package");
        if (!d.default) throw new Error(m + " requires React to be available");
        t.propTypes = b, t.PropTypes = b, t.default = e.exports;
        ...
        "object" === ("undefined" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ ? "undefined" : i(__MOBX_DEVTOOLS_GLOBAL_HOOK__)) && __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobxReact(e.exports, l.default)
    }, function(e, t, r) {
        "use strict";
        ...
        function c(e, t) {
            ...
            if (Array.isArray(e)) return t ? O.default.apply(null, e)(c(t)) : function(t) {
                return c(e, t)
            };
            var r = e;
            if (!("function" != typeof r || r.prototype && r.prototype.render || r.isReactClass || d.default.Component.isPrototypeOf(r))) return c(d.default.createClass({
            ...
            return ["componentWillMount", "componentWillUnmount", "componentDidMount", "componentDidUpdate"].forEach(function(e) {
                u(n, e)
            }), n.shouldComponentUpdate || (n.shouldComponentUpdate = x.shouldComponentUpdate), r.isMobXReactObserver = !0, r
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var f = r(2),
            ...
            _ = t.renderReporter = new v.default,
            x = {
                ...
                shouldComponentUpdate: function(e, t) {
                    ...
                    for (var n = void 0, o = r.length - 1; n = r[o]; o--) {
                        var i = e[n];
                        if (i !== this.props[n]) return !0;
                        if (i && "object" === ("undefined" == typeof i ? "undefined" : s(i)) && !l.default.isObservable(i)) return !0
                    }
                    return !1
                }
            }
        ...
        (function(e) {
            ...
            function o(e, t) {
                ...
                return r.contextTypes = {
                    mobxStores: c.PropTypes.object
                }, r.wrappedComponent = t, i(r, t), (0, l.default)(r, t), r
            }
        ...
        function o() {
            d && l && (d = !1, l.length ? p = l.concat(p) : y = -1, p.length && i())
        }
            ...
            l = function(e) {
                ...
                return a(t, e), u(t, [{
                    ...
                    value: function() {
                        ...
                        for (var n in this.props) f[n] || (e[n] = this.props[n]);
                        return {
                            mobxStores: e
                        }
                    }
                    ...
                    value: function(e) {
                        ...
                        for (var t in e) f[t] || this.props[t] === e[t] || console.warn("MobX Provider: Provided store '" + t + "' has changed. Please avoid replacing stores as the change might not propagate to all children")
                    }
                }]), t
            }(c.Component);
        l.contextTypes = {
            ...
            mobxStores: c.PropTypes.object.isRequired
        }, t.default = l
    }, function(e, t, r) {
        "use strict";
        ...
        function n(e) {
            function t(t, r, n, o, i, a) {
                for (var u = arguments.length, c = Array(u > 6 ? u - 6 : 0), s = 6; s < u; s++) c[s - 6] = arguments[s];
        ...
        function u(e, t) {
            return n(function(r, n, o, u, c) {
                return (0, f.untracked)(function() {
                    if (e && i(r[n]) === t.toLowerCase()) return null;
                    var u = void 0;
                    switch (t) {
                        case "Array":
        ...
        function c(e, t) {
            return n(function(r, n, o, i, a) {
                for (var c = arguments.length, s = Array(c > 5 ? c - 5 : 0), l = 5; l < c; l++) s[l - 5] = arguments[l];
                return (0, f.untracked)(function() {
                    if ("function" != typeof t) return new Error("Property `" + a + "` of component `" + o + "` has invalid PropType notation.");
                    var c = u(e, "Array")(r, n, o);
                    if (c instanceof Error) return c;
                    for (var f = r[n], l = 0; l < f.length; l++)
                        if (c = t.apply(void 0, [f, l, o, i, a + "[" + l + "]"].concat(s)), c instanceof Error) return c;
                    return null
                })
            })
        }
