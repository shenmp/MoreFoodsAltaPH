"use strict";
define("messageView", ["lodash", "react", "core", "santaProps", "siteButton"], function(t, e, o, i, s) {
    function n() {
        var t = {
                label: "OK",
                id: "ok"
        ...
        return this.createChildComponent(t, "wysiwyg.viewer.components.SiteButton", "okButton", {
            skinPart: "okButton",
            compProp: e,
    ...
    return {
        ...
        }, i.santaTypesUtils.getSantaTypesByDefinition(s)),
        statics: {
            useSantaTypes: !0
        },
