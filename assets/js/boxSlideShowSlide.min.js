"use strict";
define("boxSlideShowSlide", ["lodash", "react", "mediaCommon", "containerCommon"], function(e, o, i, n) {
    var t = n.mixins.containerMixin;
    return {
        displayName: "boxSlideShowSlide",
        mixins: [i.mediaLogicMixins.fill, t],
        propTypes: {
            shouldHideOverflowContent: o.PropTypes.bool,
            flexibleBoxHeight: o.PropTypes.bool,
            onMouseEnter: o.PropTypes.func,
            onMouseLeave: o.PropTypes.func,
            parentId: o.PropTypes.string,
            minHeight: o.PropTypes.number
        },
        statics: {
            useSantaTypes: !0,
            behaviors: i.mediaBehaviors.fill
        },
