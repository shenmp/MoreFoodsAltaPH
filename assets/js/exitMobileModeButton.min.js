"use strict";
define("exitMobileModeButton", ["lodash", "core", "utils", "buttonCommon", "santaProps"], function(e, i, o, t, n) {
    function r(e, i, o) {
        var t = s.renderLink({
    ...
    var s = o.linkRenderer;
    return {
        displayName: "ExitMobileModeButton",
        mixins: [i.compMixins.skinBasedComp, t.buttonMixin],
        propTypes: {
        ...
        getSkinProperties: function() {
            var e = {
                link: r.call(this, this.props.linkRenderInfo, this.props.compProp, this.props.rootNavigationInfo),
                label: {
                    children: [this.props.compData.label],
                    style: this.getLabelStyle(this.props)
                }
            };
            return this.resetMinHeightIfNeeded(e), e
        }
    }
});
