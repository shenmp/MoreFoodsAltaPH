"use strict";
define("disqusComments/translations/disqusComments", [], {
    de: {
...
}), define("disqusComments", ["core", "utils", "lodash", "santaProps", "disqusComments/translations/disqusComments"], function(s, e, t, i, n) {
    var a = s.compMixins,
        o = e.urlUtils;
    return {
        ...
        propTypes: {
            ...
            languageCode: i.Types.RendererModel.languageCode.isRequired,
            santaBase: i.Types.santaBase,
            rootPageData: i.Types.rootPageData,
            currentUrl: i.Types.currentUrl.isRequired
        },
        statics: {
            useSantaTypes: !0
        },
        mixins: [a.skinBasedComp, a.postMessageCompMixin, a.uniquePageIdMixin],
        getDisqusInstanceId: function() {
            return this.getDisqusId && this.getDisqusId() || this.getUniquePageId()
        },
        getIframeSrc: function() {
            var s = this.props.rootPageData,
                e = this.getDisqusInstanceId(),
                i = {
                    disqusId: this.props.compData.disqusId ? this.props.compData.disqusId : "wixdemo123",
                    pageUrl: t.isString(this.props.currentUrl) ? this.props.currentUrl : this.props.currentUrl.full,
                    pageTitle: s.title,
                    compId: this.props.id,
                    disqusInstanceId: e
                };
            return this.props.santaBase + "/static/external/disqusComments.html?" + o.toQueryString(i)
        },
        getSkinProperties: function() {
            var s = !!this.props.compData.disqusId;
            return {
                "": {
                    style: {
        ...
        componentWillReceiveProps: function(s) {
            this.setState({
                $disqusId: s.compData.disqusId
            })
        },
        getTranslation: function(s) {
            return this.translatedKeys[s] || s
        },
        getInitialState: function() {
            return this.translatedKeys = n[this.props.languageCode] || {}, {
                $disqusId: this.props.compData.disqusId,
                $disqusCommentsDesiredHeight: 200
            }
        },
        onDisqusCommentsHolderMsg: function(s) {
            this.prevHeight = this.state.$disqusCommentsDesiredHeight, this.setState({
                $disqusCommentsDesiredHeight: s.height
            }), this.prevHeight !== s.height && this.registerReLayout()
        },
