"use strict";
define("stripSlideShowSlide", ["lodash", "react", "mediaCommon", "containerCommon"], function(e, i, o, n) {
    var s = n.mixins.containerMixin;
    return {
        displayName: "stripSlideShowSlide",
        mixins: [o.mediaLogicMixins.fill, s],
        propTypes: {
            shouldHideOverflowContent: i.PropTypes.bool,
            flexibleBoxHeight: i.PropTypes.bool,
            onMouseEnter: i.PropTypes.func,
            onMouseLeave: i.PropTypes.func,
            parentId: i.PropTypes.string,
            minHeight: i.PropTypes.number
        },
        statics: {
            useSantaTypes: !0,
